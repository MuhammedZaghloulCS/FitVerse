...
namespace FitVerse.Data.UnitOfWork
{
    public class UnitOfWorkService :IUnitOFWorkService
    {
        ...
        public IPaymentRepository PaymentRepository => paymentRepository ??= new PaymentRepository(context);

        // Generic repositories for direct access
        public IGenericRepository<FitVerse.Data.Models.Coach> Coaches => unitOfWork.Coaches;
        public IGenericRepository<FitVerse.Data.Models.Client> Clients => unitOfWork.Clients;
    }
}
